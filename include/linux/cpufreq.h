...
enum {
	BOOT_CPU = 0,
#if defined(CONFIG_SEC_MILLET_PROJECT) || defined(CONFIG_SEC_MATISSE_PROJECT) || defined(CONFIG_SEC_VICTOR_PROJECT) || 	defined(CONFIG_SEC_BERLUTI_PROJECT)|| defined(CONFIG_SEC_FRESCONEOLTE_PROJECT) || defined(CONFIG_SEC_AFYON_PROJECT)
	NON_BOOT_CPU,
#endif
};
#if defined(CONFIG_SEC_MILLET_PROJECT) || defined(CONFIG_SEC_MATISSE_PROJECT) || defined(CONFIG_SEC_VICTOR_PROJECT) || defined(CONFIG_SEC_BERLUTI_PROJECT)|| defined(CONFIG_SEC_FRESCONEOLTE_PROJECT) || defined(CONFIG_SEC_AFYON_PROJECT)

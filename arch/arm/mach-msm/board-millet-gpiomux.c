...
static struct gpiomux_setting accel_irq_act_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
...
static struct gpiomux_setting accel_irq_sus_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config msm_nativesensors_configs[] __initdata = {
	...
	},
	{
		.gpio	   = 54,		/* ACCEL IRQ */
		.settings = {
			[GPIOMUX_ACTIVE] = &accel_irq_act_config,
			[GPIOMUX_SUSPENDED] = &accel_irq_sus_config,
		},
	},
};
#endif
...
static struct msm_gpiomux_config msm_ta_nchg_configs[] = {
	{
		...
		.settings = {
			...
			[GPIOMUX_SUSPENDED] = &ta_nchg_cfg[1],
		},
	},
};
